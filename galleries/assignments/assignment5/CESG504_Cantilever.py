...
# %%
# Using a distorted mesh
# ------------------------

class ExamplePlate11b(Example):
    ...
    def problem(self):
        ...
        mesher = PatchMesher(model, (0., 0.), (Lx, 0.), (Lx, Ly), (0., Ly),  (0.25*Lx, 0.), None,  (0.75*Lx, Ly), None)
        nodes, elements = mesher.quadMesh(Nx, Ny, Quad, PlaneStress(params))
